...
export const HomeScreen = ({ navigation }) => {
    ...
    {/*First Card/Section */}
                <View style={[GlobalStyles.cardSection]}>
                    <View style={[styles.titleSection]}>
                        {/*Header*/}
                        <Text style={[GlobalStyles.headerText, {marginTop: "0.04rem", marginBottom: "0.8rem", marginHorizontal: "1.5625rem", fontSize: "2.052rem", lineHeight: "3.125rem"}]}>
                            The World’s Fastest{"\n"}
                            {/*Inline Bold Text*/}
                        ...
                        />
                        {/*Create Event Button*/}
                        <TouchableOpacity style={[GlobalStyles.submitButton, {marginTop: "4.776rem", marginBottom: "4.6875rem"}]}
                            onPress={() => {
    ...
    {/*sixth: Tile Section: and it's all free */}
